...
const WorkDetail = () => {
  ...
  return (
    <main className="bg-white text-lg text-black">
      ...
      {/*  HERO  */}
      <section className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 md:pt-10 pb-10 sm:pb-12 md:pb-16">
        <Link to="/" className="inline-block mb-4">
          <p className="text-sm sm:text-base hover:underline">Back</p>
        </Link>
        <div className="flex flex-col md:flex-row md:items-center gap-4 sm:gap-6 mt-4 sm:mt-6 md:mt-8 lg:mt-10">
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3">VexLogic AI Assistant</h1>

            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 text-xs sm:text-sm text-gray-500">
              <span>Role: UI/UX Designer</span>
              <span className="flex items-center gap-1">
                <Icon icon="iconamoon:clock-thin" className="w-4 h-4 sm:w-5 sm:h-5" />
                <span>Timeline: 3hr</span>
              </span>
            </div>
          </div>

          <p className="max-w-full sm:max-w-sm md:max-w-md md:ml-auto text-sm sm:text-base">
      ...
      {/*  PROJECT OVERVIEW  */}
      <section className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-8 md:py-10 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
        <div>
          <img
            src="/assets/overview2.png"
            alt="Overview"
            className="w-full max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg xl:w-[550px] h-auto"
            loading="lazy"
            srcSet="/assets/overview2.png 400w, /assets/overview2.png 600w"
            sizes="(max-width: 640px) 100vw, (max-width: 768px) 400px, (max-width: 1024px) 500px, 550px"
          />
        </div>
        <div>
      ...
      <section className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-8 md:py-10 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 md:gap-20">
        <div>
          ...
          <ul className="space-y-2 sm:space-y-3 list-disc pl-5 mb-4 sm:mb-6 md:mb-10 marker:text-xl sm:marker:text-2xl md:marker:text-3xl text-sm sm:text-base">
      ...
      <section className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-6 sm:py-8 md:py-10 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 md:gap-20">
        ...
        <div>
          ...
          <p className="font-semibold mb-3 text-sm sm:text-base">Key Point</p>
          <ul className="space-y-2 sm:space-y-3 list-disc pl-5 mb-4 sm:mb-6 md:mb-10 marker:text-xl sm:marker:text-2xl md:marker:text-3xl text-sm sm:text-base">
      ...
      <section id="work" className="bg-white">
        <div className="max-w-360 mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
          {/* Heading */}
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-2 text-black">
            My Works
          </h2>
          <p className="text-black text-center mb-6 sm:mb-8 md:mb-12 text-sm sm:text-base md:text-lg px-4">
            Discover My Latest Work And Strategic Solutions That Shape Business
            Growth
          </p>

          {/* Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 text-base sm:text-lg text-black">
            {[
              {
                title: "Development",
