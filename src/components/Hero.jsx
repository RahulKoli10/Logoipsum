...
const Hero = () => {
  return (
    <section className="font-dm bg-[#F6F8FF]">
      <div className="mx-25 py-16 flex flex-col md:flex-row items-center justify-between gap-12">
        {/* LEFT CONTENT */}
        <div className="flex-1 w-164 pt-10">
          <p className="text-lg text-black mb-2">Hey, I'm Nitish Kumar</p>

          <h1 className="text-6xl md:text-5xl font-bold text-black tracking-wider">
            Co-founder <br />
        ...
        <div className="flex-1 flex justify-center mt-10 md:mt-0">
          <div className="relative">
            ...
            <img
              ...
              alt="CEO"
              className="w-full max-w-xs sm:max-w-sm md:max-w-lg lg:w-133 rounded-xl object-cover"
            />
          </div>
        </div>
      </div>
